...
> **NOTE:**
> The harms considerations below do not include risks from security threats (e.g. attackers aiming to compromise the security of the system). For more information on the threat modeling process see the [Security Considerations](Security_Considerations.html.md).
...
*   Inadvertent disclosure of information: C2PA claim generators may automatically add, or require to add, information to manifests that may be sensitive. [User experience guidance](../../2.2/ux/UX_Recommendations.html.md) has been published alongside the specs to offer a clear acknowledgement of creator consent before a C2PA implementation can begin accumulating data.
...
The C2PA has also published a [guide for implementers](#2.1@guidance:Guidance.adoc) that will be continuously updated in order to facilitate a C2PA ecosystem that reflects a broad spectrum of needs and circumstances.
