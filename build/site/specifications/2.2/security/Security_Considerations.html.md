...
This document provides information security considerations for technology described in the [C2PA core specification](../../2.1/specs/C2PA_Specification.html.md). It complements security-related content in other C2PA documents. This document includes:
...
This section summarizes C2PA features that support the [security model](#_security_model) specified later in this document. The [C2PA core specification](../../2.1/specs/C2PA_Specification.html.md) should be considered the canonical reference for C2PA features. It supersedes summaries provided here.
...
Details on supported cryptographic hashing and signature schemes, as well as format details, are covered in the specification’s [Cryptography section](../../2.1/specs/C2PA_Specification.html.md#_cryptography). As noted there, the C2PA maintains lists of supported algorithms and certificate types that aim to adhere to cryptographic and compatibility best practices.

Detail on how signing credentials relate to identity are included in the [Trust Model section](../../2.1/specs/C2PA_Specification.html.md#_trust_model) of the specification. The [Validation section](../../2.1/specs/C2PA_Specification.html.md#_validation) provides details on validating claims, which includes validating signatures.
...
[Validation](../../2.1/specs/C2PA_Specification.html.md#validation-clause) of content claim signatures is critical to the C2PA security model. Validation checks provenance claim signatures and performs supporting operations. The C2PA validation model begins by confirming that a piece of content is ["Well-Formed"](../../2.1/specs/C2PA_Specification.html.md#_well_formed_manifest). In short, an asset is "Well-Formed" if it can be parsed without syntax errors. A Well-Formed piece of content can also be [Valid](../../2.1/specs/C2PA_Specification.html.md#_valid_manifest), if the data within the Well-Formed asset has a matching cryptographic signature that has not been revoked, and is within its validity period. A Well-Formed, Valid piece of content is considered to be [Trusted](../../2.1/specs/C2PA_Specification.html.md#_trusted_manifest) if the certificate used for the valid signature chains up to a known Trust Anchor.

There are many phases of validation checks that must be completed if a piece of content is to be considered Well-Formed, Valid or Trusted. These phases include [validating the asset’s content](../../2.1/specs/C2PA_Specification.html.md#_validate_the_assets_content), [validating the assertions](../../2.1/specs/C2PA_Specification.html.md#_validate_the_assertions), [validating the ingredients](../../2.1/specs/C2PA_Specification.html.md#_validate_the_ingredients), [validating the signature](../../2.1/specs/C2PA_Specification.html.md#_validate_the_signature), [validating the time-stamp](../../2.1/specs/C2PA_Specification.html.md#_validate_the_time_stamp), and [validation the credential revocation information](../../2.1/specs/C2PA_Specification.html.md#_validate_the_credential_revocation_information). All of these validations must succeed in order for a piece of content to be considered Valid.

The success of the validation is returned by status codes that indicate successes, failures, and information codes as defined in [Section 15.2](../../2.1/specs/C2PA_Specification.html.md#_returning_validation_results). A validator should not present C2PA manifest data to the consumer if any part of the content is not considered to be Vaild or Trusted, as defined in [section 15.3](../../2.1/specs/C2PA_Specification.html.md#_displaying_manifest_information). These steps help to ensure that content consumers do not get misled by potentially maliciously altered or fake content.

The complete validation algorithm is described in detail in the [validation section of the C2PA specification](../../2.1/specs/C2PA_Specification.html.md#_validation).
...
*   Assertions that may contain sensitive information can be removed via [redaction](../../2.1/specs/C2PA_Specification.html.md#_redaction_of_assertions).
...
Organizations may want to leverage C2PA as a means to verify the provenance of data used to train AI and ML models. This can be one step in the overall process to help ensure that the models are trained using source data that is trustworthy. An in-depth discussion of this complex topic is provided in the C2PA [Guidance for Artificial Intelligence and Machine Learning](../ai-ml/ai_ml.html.md).
...
*   C2PA does not specify guarantees of confidentiality of personal information.
    ...
    *   Confidentiality of personal information and other privacy-related concerns are addressed in the [Harms Considerations document](Harms_Modelling.html.md).
        ...
        In general, these assertions are achieved through application of the [C2PA Trust Model](../../2.1/specs/C2PA_Specification.html.md#_trust_model) to the claim generation process, and corresponding checks in the validation process.
...
Use of manifest repositories can introduce security and privacy issues. See the [Content binding security section](#_content_binding) for more information.
...
An attacker is able to perform the copying as described. However, C2PA hard bindings provide a cryptographic binding between assets and C2PA Manifests via claim signatures. Thus, [validation checks](../../2.1/specs/C2PA_Specification.html.md#_validation) (e.g., as implemented by a user agent) will detect the replaced C2PA Manifests.
...
Validation of ingredients is optional, however, validation of the hash of the ingredient’s manifest at the time it was added to the active manifest as an ingredient is not. See the [Validation section of the C2PA specification](../../2.1/specs/C2PA_Specification.html.md#_validation) for details.
...
Claim generators should add [review ratings](../../2.1/specs/C2PA_Specification.html.md#_review_ratings) to their assertion metadata to propagate their assessment of ingredients to downstream consumers. When this validation is performed on both media assets described in this scenario, downstream consumers will be able to differentiate between them.
...
C2PA provides guidance on applying soft bindings, which may include algorithms for mitigating this type of attack. See the [content binding documentation](../../2.1/specs/C2PA_Specification.html.md#_binding_to_content) for details.
...
The attacker needs to have access to a compute resource capable of brute-forcing the expected space of the redacted field that they are targeting. If a unique, cryptographically random [C2PA salt](../../2.1/specs/C2PA_Specification.html.md#_hashing_jumbf_boxes) was included with the assertion, then brute-forcing the original value should not be feasible.
...
In addition, refer to the C2PA [User Experience Guidance](#2.1@ux:UX_Recommendations.adoc) for details on how to display this information to an end-user.
