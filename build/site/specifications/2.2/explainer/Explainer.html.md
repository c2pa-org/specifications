...
For additional information, see the [Trust Model](../specs/C2PA_Specification.html.md#_trust_model) section of the [Technical Specifications](../specs/C2PA_Specification.html.md).
...
Yes it can. When an asset is created from a series of other assets, those additional assets are referred to as its [ingredients](../specs/C2PA_Specification.html.md#_ingredient). Each ingredient that is used in the (composed) asset is recorded in that asset’s provenance, including the addition of the provenance of each individual ingredient. This process creates a tree of provenance, much like a family tree, that can stretch all the way back to each ingredient’s creation.
...
An example of `c2pa.created` action that might appear in an asset that was produced by a Generative AI system appears in the specification’s [parameters clause of Actions](../specs/C2PA_Specification.html.md#_parameters).
