...
![Disclosure levels](../../2.2/ux/_images/disclosure_summary.png)
...
![Content Credentials logo and icon](../../2.2/ux/_images/icon_and_wordmark.png)
...
<a id="correct-usage-of-the-icon"></a>
#### 4.2.1. Correct usage of the icon

![Correct usage of the icon](../../2.2/ux/_images/icon_usage.png)
...
![Placement options for the L1 indicator](../../2.2/ux/_images/L1_display_options.png)
...
![Minimum viable provenance display](../../2.2/ux/_images/L2_mvp.png)
...
![Provenance summary depth versus breadth](../../2.2/ux/_images/L2_spectrum.png)
...
![A single manifest summary with optional displays of assertions](../../2.2/ux/_images/L2_depth.png)
...
![Provenance summary](../../2.2/ux/_images/L2_summary_1.png)
...
![Provenance summary](../../2.2/ux/_images/L2_summary_2.png)
...
![Provenance summary](../../2.2/ux/_images/L2_summary_3.png)
...
![Provenance summary](../../2.2/ux/_images/L2_summary_4.png)
...
![Provenance summary](../../2.2/ux/_images/L2_summary_5.png)
...
![Customized summary combinations](../../2.2/ux/_images/L2_combinatory_summaries.png)
...
![Invalid data in the active manifest position](../../2.2/ux/_images/L2_invalid_active.png)

Figure 15. Invalid data in the active manifest position

![Invalid data in an ingredient position](../../2.2/ux/_images/L2_invalid_ingredient.png)
...
![L3 tree view](../../2.2/ux/_images/L3_tree_view.png)
...
![Compare state](../../2.2/ux/_images/L3_compare.png)
...
![Manifest recovery](../../2.2/ux/_images/L3_manifest_recovery.png)
...
![Redactions in L2](../../2.2/ux/_images/L2_redaction.png)
...
<a id="_user_facing_labels_and_descriptions"></a>
### 7.3. User-facing labels and descriptions
...
| Recommended user-facing L1 label | IPTC digitalSourceType | C2PA action(s) | Other metadata | Ingredient relationship | Operation | Recommended user-facing description |
| --- | --- | --- | --- | --- | --- | --- |
| `AI-generated` | trainedAlgorithmicMedia | c2pa.created |  |  | Synthetic media; Generation of an entire new asset | This {TYPE} was completely AI-generated. |
| `AI-generated` | trainedAlgorithmicMedia | c2pa.created, c2pa.opened |  | inputTo | AI-generated style/object transfer; Generation of an entire new asset, in the style of or incorporating elements from a reference asset | This {TYPE} was completely AI-generated, incorporating the style or other elements of a separate reference {TYPE}. |
| `AI-edited` | compositeWithTrainedAlgorithmicMedia | c2pa.placed or c2pa.deleted |  | componentOf | Synthetic compositing; Adding AI-generated content to existing content, or replacing existing content with AI-generated content | This {TYPE} contains AI-generated content, but was not completely AI-generated. |
| `AI-edited` | compositeWithTrainedAlgorithmicMedia | c2pa.dubbed | Lips region of interest (ROI), transcript ROI |  | Manipulating an asset for dubbing purposes | AI was used to adjust lip movements and change spoken words with transcript edits |
| `Camera-captured` | digitalCapture |  |  |  | The digital media is captured from a real-life source using a digital camera or digital recording device | This {TYPE} was captured from a real-life source using a digital camera or digital recording device |
...
<a id="_general_framework_appearance"></a>
### 7.4. General framework appearance
...
![Progressive disclosure UI with labeling](../../2.2/ux/_images/content_disclosure_1.png)
...
![L1 with optional disclosure labels](../../2.2/ux/_images/content_disclosure_2.png)
...
![L1 label syles](../../2.2/ux/_images/content_disclosure_3.png)
...
![L2 interaction patterns for disclosure](../../2.2/ux/_images/content_disclosure_4.png)
...
![L3 thumbnail with label](../../2.2/ux/_images/content_disclosure_5.png)
...
![L3 manifest panel with label description](../../2.2/ux/_images/content_disclosure_6.png)

Figure 28. L3 manifest panel with label description

<a id="_interaction_3"></a>
#### 7.7.3. Interaction
...
![Select states for a manifest thumbnail](../../2.2/ux/_images/content_disclosure_7.png)
...
![L3 tree view with labels](../../2.2/ux/_images/content_disclosure_8.png)
...
### 8.1. Opting in, privacy and data collection
...
### 8.2. Creator settings and manifest preview

Creators should be able to control the information in their assertions as much as is allowed by C2PA specifications. The [Harms Modelling document](../../1.4/security/Harms_Modelling.html.md) covers the reasoning behind why creator control is imperative. To provide coverage against harms and misuse, C2PA suggests the following types of assertions be manageable by the creator:
...
### 8.4. Ingredients and their validation state
...
![Example of manifest storage settings](../../2.2/ux/_images/creator_manifest_storage.png)
...
![Example of correct and incorrect placement of L1 indicator](../../2.2/ux/_images/video_placement_0.png)
...
#### 9.1.2. L1 - indicator of C2PA data

<a id="_appearance_4"></a>
##### 9.1.2.1. Appearance
...
![L1 indicator should be visible throughout the video](../../2.2/ux/_images/video_appearance.png)
...
![The two validation states: valid and invalid](../../2.2/ux/_images/video_validation_states.png)
...
![Illustrative examples of L1 positioning within the video player. From left to right: a) Top right b)Bottom left c) Within controls.](../../2.2/ux/_images/video_placement_1.png)
...
#### 9.1.3. L2 - provenance summaries

<a id="_appearance_5"></a>
##### 9.1.3.1. Appearance
...
###### 9.1.3.1.1. Validated segments (for video streaming only)
...
![Illustrative example showing disclosure of invalid video segment on the timeline](../../2.2/ux/_images/video_placement_2.png)
...
![Three examples of L2 placement](../../2.2/ux/_images/video_placement_3.png)
...
<a id="_interaction_5"></a>
##### 9.1.3.3. Interaction

<a id="_status_summaries_for_invalid_states"></a>
###### 9.1.3.3.1. Status Summaries for Invalid States
...
[Failure codes](../../1.4/specs/C2PA_Specification.html.md#_failure_codes) `manifest.inaccessible` and `assertion.inaccessible` do not suggest invalidity and instead represent temporarily inaccessible information due to connection issues. These should be handled by the player as they are not considered validation issues.

![Illustrative example of a L2 summary for an invalid state for streaming playback](../../2.2/ux/_images/video_status_summaries_for_invalid_states.png)
...
###### 9.1.3.3.2. Active Manifest Data
...
#### 9.1.4. Validation process

<a id="_dynamic_video_streaming"></a>
##### 9.1.4.1. Dynamic Video Streaming
...
##### 9.1.4.4. User-video-player interactions and their impact on validation
...
![Flow showing a) when the manifest and asset validations happen during the video streaming experience b) the validation status logic across this journey](../../2.2/ux/_images/video_streaming_validation_process.png)
...
![Anatomy of a thumbnail](../../2.2/ux/_images/thumbnail_anatomy.png)
...
<a id="_media_representations"></a>
#### 9.2.2. Media representations
...
| Content credentials are invalid | Someone or something has changed or tampered with the content credentials, so the available data should be disregarded | Should follow L1 validation state |
...
### 10.4. L2/L3 user-facing warnings and errors
...
### 10.5. Difficult terms and concepts, and possible alternatives
...
### 12.2. Applications, use cases, and additional media formats
...
## 13\. Public review, feedback and evolution
